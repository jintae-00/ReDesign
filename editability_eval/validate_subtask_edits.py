...
def _module_presence() -> Dict[str, Any]:
    required = {
        "atomic": [
            "editability_eval.subtasks.atomic.delete",
            "editability_eval.subtasks.atomic.transition",
            "editability_eval.subtasks.atomic.rotation",
            "editability_eval.subtasks.atomic.opacity",
            "editability_eval.subtasks.atomic.z_order",
        ],
        "text": [
            "editability_eval.subtasks.text.content_recognition",
            "editability_eval.subtasks.text.content_modification",
            "editability_eval.subtasks.text.style_scaling",
            "editability_eval.subtasks.text.style_bold",
            "editability_eval.subtasks.text.style_italic",
            "editability_eval.subtasks.text.style_recolor",
            "editability_eval.subtasks.text.style_combo",
        ],
        "svg": [
            "editability_eval.subtasks.svg.super_scaling",
            "editability_eval.subtasks.svg.stroke",
            "editability_eval.subtasks.svg.corner_radius",
            "editability_eval.subtasks.svg.aspect_ratio",
            "editability_eval.subtasks.svg.recolor",
            "editability_eval.subtasks.svg.point_edit",
        ],
    }
    out: Dict[str, Any] = {}
