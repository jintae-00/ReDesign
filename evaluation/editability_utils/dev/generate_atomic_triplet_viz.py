...
from evaluation.editability_utils.run_atomic_edit_radnom import _build_pair_meta_index, _save_triplet_visualizations_for_subtask, _triplet_task_key
...
def _run_reconstruct_backend(args: argparse.Namespace, subtasks: List[str]) -> None:
    ...
    cmd = [
        sys.executable,
        "-m",
        "evaluation.editability_utils.generate_atomic_triplet_viz_reconstruct",
        "--output-dir",
        str(args.output_dir),
        "--figma-data",
        str(args.figma_data),
